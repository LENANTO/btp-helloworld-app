		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#helloworldui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"helloworldui5-display": {
								"semanticObject": "helloworldui5",
								"action": "display",
								"description": "A Fiori HelloWorld application.",
								"title": "HelloWorld App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=helloworldui5",
									"url": sap.ui.require.toUrl("helloworldui5")
								}
							}
						}
					}
